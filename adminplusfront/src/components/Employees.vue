    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-gray-500 mt-1">
          Gérez tous vos collaborateurs en un seul endroit
        </p>
      </div>
      <button
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
      <div class="p-6 border-b border-gray-100">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <button
            @click="loadEmployees"
            class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium flex items-center justify-center gap-2"
          >
            <svg
              class="w-5 h-5"
              fill="none"
      ...
      <div v-if="loading" class="p-12 flex justify-center">
        <div class="text-center">
          ...
          <p class="text-gray-600">Chargement des collaborateurs...</p>
        </div>
      </div>
      ...
      <div class="p-6 border-t border-gray-100">
        <p class="text-sm text-gray-600">
          ...
          {{ searchQuery || statusFilter ? " (filtrés)" : "" }}
        </p>
      </div>
    </div>
...
// Computed property pour filtrer les employés en fonction de la recherche et du statut
